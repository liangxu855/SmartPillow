...
import com.example.administrator.smartpillow.utils.other.DimensUtils;
...
public class ToastUtils {
    ...
    public static void getToastShort(String content) {
        myToast.makeText(MyApplication.getContext(), content, Toast.LENGTH_SHORT).show();
    }
    ...
    public static void getToastLong(String content) {
        myToast.makeText(MyApplication.getContext(), content, Toast.LENGTH_LONG).show();
    }
