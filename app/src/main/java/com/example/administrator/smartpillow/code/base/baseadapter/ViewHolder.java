package com.example.administrator.smartpillow.code.base.baseadapter;
...
import com.example.administrator.smartpillow.utils.bitmap.GlideOptions;
import com.example.administrator.smartpillow.utils.bitmap.GlideUtils;
import com.example.administrator.smartpillow.utils.ui.UiUtils;
import com.example.administrator.smartpillow.widget.BadgeView;
...
public class ViewHolder extends RecyclerView.ViewHolder {
    ...
    public ViewHolder setBadgeCount(int viewId, int num) {
        ...
        if (num <= 0) {
            view.setBackground(mContext.getResources().getColor(R.color.mainColor));
        } else {
