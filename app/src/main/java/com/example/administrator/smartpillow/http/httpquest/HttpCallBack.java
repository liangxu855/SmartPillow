...
import com.example.administrator.smartpillow.code.base.view.iview.BaseListView;
import com.example.administrator.smartpillow.code.base.view.iview.BaseSwipeView;
import com.example.administrator.smartpillow.http.listener.StatusChangListener;
...
public abstract class HttpCallBack<ResultType> {
    ...
    public void onError(Throwable error) {
        ...
        if (!HttpLocalUtils.isNetworkAvailable(MyApplication.getContext())) {
            errString = "请检查网络设置";
            errCode = -2;
