package com.example.administrator.smartpillow.model;
...
import com.example.administrator.smartpillow.utils.other.DeviceUtil;
import com.example.administrator.smartpillow.utils.other.Md5Utils;
...
import static com.example.administrator.smartpillow.utils.db.LiteOrmUtil.getLiteOrm;
...
public class UserInfo {
    ...
    public static UserInfo getInstance() {
        try {
            ...
            userData.setMac(DeviceUtil.getInstance(MyApplication.getContext()).getmDeviceID());
...
//        LoginActivity.startUI(context, true);
        ToastUtils.showShort(MyApplication.getContext(),"跳转到登录页面");
        return true;
    }
